...
<div class="container">
    ...
    <div class="row">
        ...
        <form method="POST" action="{{ route('update_profissional', [ 'id' => $profissional->id ]) }}">
                @csrf
                @method('put')
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        <input id="nome" type="text" class="form-control @error('nome') is-invalid @enderror" name="nome" value="{{ old('nome', $profissional->nome ?? '') }}" autocomplete="nome" required maxlength="255" autofocus>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input id="cpf" type="text" class="mask_cpf form-control @error('cpf') is-invalid @enderror" name="cpf" value="{{ old('cpf', $profissional->cpf ?? '') }}" autocomplete="cpf" required maxlength="14">
