...
<div class="container">
    ...
    @if(isset($professor) && ($professor->id > 0) )
        ...
        <div class="col-md-12">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            Nome: <strong>{{ __($professor->nome)  }}</strong>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="{{ route('editar_professor', ['id' => $professor->id ]) }}" class="btn btn-primary btn-sm"><i class="far fa-edit"></i> Editar </a>
                            <a href="#" class="btn btn-danger btn-sm btn-excluir" id-professor="{{ $professor->id }}"> <i class="far fa-trash-alt"></i> Excluir </a>
                        </div>
                    </div>
                </div>
            </div>
