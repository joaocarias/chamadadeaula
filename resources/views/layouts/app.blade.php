...
<body class="body-style-for-footer">
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark bg-vermelho-cmei shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        @if((isset(Auth::user()->profissional->tipoProfissional->id) && Auth::user()->profissional->tipoProfissional->id == 1) || in_array("ADMINISTRADOR", $permissoes) )
        ...
        <div class="main-footer">
            <p>Versão 1.21.5.24 ©2020-2021 - Desenvolvido por João Carias de França</p>
        </div>
