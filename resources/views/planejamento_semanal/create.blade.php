                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <div class="form-check">
                                            ...
                                            <input id="conteudo_eu_o_outro_e_o_nos" type="text" class="form-control col-md-6 @error('conteudo_eu_o_outro_e_o_nos') is-invalid @enderror" name="conteudo_eu_o_outro_e_o_nos" value="{{ old('conteudo_teu_o_outro_e_o_nos', $planejamento->conteudo_eu_o_outro_e_o_nos ?? '') }}" autocomplete="conteudo_eu_o_outro_e_o_nos" maxlength="2000">
