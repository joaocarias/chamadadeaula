...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form method="POST" action="{{ route('cadastrar_upload_planejamento_semanal') }}" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <input id="arquivo" type="file" class="form-control @error('arquivo') is-invalid @enderror" name="arquivo" value="{{ old('arquivo', $planejamento->arquivo ?? '') }}" autocomplete="arquivo" maxlength="254" required >
