...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form method="POST" action="{{ route('revisar_planejamento_semanal', [ 'id' => $planejamento->id ]) }}">
                @csrf
                @method('put')
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <div class="card mb-3">
                            <div class="card-header">{{ __('Revisar') }}</div>
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea id="como_sera_a_avaliacao" class="summernote @error('como_sera_a_avaliacao') is-invalid @enderror" name="como_sera_a_avaliacao" autocomplete="como_sera_a_avaliacao" required>{{ old('como_sera_a_avaliacao', $planejamento->como_sera_a_avaliacao ?? '') }}</textarea>
